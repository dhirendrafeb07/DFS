  ...
  return (
    <div className="top">
      <form className="form" onSubmit={handleSubmit}>
        <label htmlFor="file-upload" className="choose button_On_Top">
          Choose Image
          <i class="fa-solid fa-image fa-xl mx-2"></i>
        </label>
        <input
          disabled={!account}
          type="file"
        ...
        <button type="submit" className="upload button_On_Top" disabled={!file}>
         Upload File
         <i class="fa-solid fa-cloud-arrow-up fa-xl mx-2" ></i>
        </button>
      </form>
    </div>
  );
